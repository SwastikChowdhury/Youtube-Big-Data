...
predicate_pushdown = "region in ('ca','gb','su')"
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://de-projects-pratice-useast1-dev/de-youtube-big-data-raw/clean_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
